...
class ModalBilheteYesLoginWidget extends StatefulWidget {
  const ModalBilheteYesLoginWidget({Key key}) : super(key: key);

  @override
  _ModalBilheteYesLoginWidgetState createState() =>
      _ModalBilheteYesLoginWidgetState();
}

class _ModalBilheteYesLoginWidgetState
    extends State<ModalBilheteYesLoginWidget> {
  @override
